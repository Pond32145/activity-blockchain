    ...
    return (
        <div onClick={handleLogout}>
            <div className="w-full flex items-center justify-center cursor-pointer">
                <div className="relative inline-flex items-center justify-start py-2 pl-3 pr-8 overflow-hidden font-semibold shadow text-red-600 transition-all duration-150 ease-in-out rounded hover:pl-8 hover:pr-4 bg-gray-50 dark:bg-gray-700 dark:text-white dark:hover:text-gray-200 dark:shadow-none group">
                    <span className="absolute bottom-0 left-0 w-full h-0.5 transition-all duration-150 ease-in-out bg-red-600 group-hover:h-full"></span>
